...
pub const SYS_SCHEED_GETSCHEDULER: usize = 120;
...
pub const SYSCALL_FRAMEBUFFER: usize = 1002;
pub const SYSCALL_FRAMEBUFFER_FLUSH: usize = 1003;
pub const SYSCALL_EVENT_GET: usize = 1004;
pub const SYSCALL_LISTEN: usize = 1005;
pub const SYSCALL_CONNNET: usize = 1006;
