...
impl<'a> Syscall<'a> {
    ...
    async fn syscall_inner(&mut self, id: SyscallID, args: [usize; 6]) -> SyscallResult {
        ...
        match id {
            ...
            SYS_PREADV =>           self.sys_preadv(args[0], args[1], args[2], args[3]).await,
            SYS_PREADV2 =>          self.sys_preadv2(args[0], args[1], args[2], args[3], args[4] as i32).await,
            ...
            SYS_PWRITEV =>          self.sys_pwritev(args[0], args[1], args[2], args[3]).await,
            SYS_PWRITEV2 =>         self.sys_pwritev2(args[0], args[1], args[2], args[3], args[4] as i32).await,
            ...
            SYS_FCHDIR =>           self.sys_fchdir(args[0]),
            ...
            SYS_FSTATAT =>          self.sys_fstatat(args[0] as isize, args[1], args[2], args[3] as i32).await,
            SYS_STATFS =>           self.sys_statfs(args[0], args[1]).await,
            SYS_FSTATFS =>          self.sys_fstatfs(args[0], args[1]).await,
            ...
            SYS_GETRLIMIT =>        self.sys_getrlimit(args[0] as _, args[1]).await,
            SYS_SETRLIMIT =>        self.sys_setrlimit(args[0] as _, args[1] as _).await,
            ...
            SYS_FACCESSAT =>        self.sys_faccessat(args[0], args[1], args[2]as i32),
            SYS_FACCESSAT2 =>       self.sys_faccessat2(args[0], args[1], args[2]as i32, args[3] as i32),
            ...
            SYS_TRUNCATE =>         self.sys_truncate(args[0], args[1] as isize).await,
            ...
            SYS_SYNC_FILE_RANGE =>  self.sys_sync_file_range(args[0], args[1] as isize, args[2] as isize,args[2] as i32),
            ...
            SYS_ACCEPT4 =>      self.sys_accept4(args[0], args[1], args[2], args[3] as i32).await,
            ...
            SYS_SETREUID =>             self.sys_setreuid(args[0] as i32, args[1] as i32),
            SYS_SETREGID =>             self.sys_setregid(args[0] as i32, args[1] as i32),
            SYS_SETRESUID =>            self.sys_setresuid(args[0] as i32, args[1] as i32, args[2] as i32),
            SYS_GETRESUID =>            self.sys_getresuid(args[0], args[1], args[2]).await,
            SYS_SETRESGID =>            self.sys_setresgid(args[0] as i32, args[1] as i32, args[2] as i32),
