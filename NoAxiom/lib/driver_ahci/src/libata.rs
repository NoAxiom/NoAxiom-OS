...
pub type SataFisType = u8;
pub const SATA_FIS_TYPE_SET_DEVICE_BITS_D2H: SataFisType = 161;
pub const SATA_FIS_TYPE_PIO_SETUP_D2H: SataFisType = 95;
pub const SATA_FIS_TYPE_BIST_ACT_BI: SataFisType = 88;
pub const SATA_FIS_TYPE_DATA_BI: SataFisType = 70;
pub const SATA_FIS_TYPE_DMA_SETUP_BI: SataFisType = 65;
pub const SATA_FIS_TYPE_DMA_ACT_D2H: SataFisType = 57;
pub const SATA_FIS_TYPE_REGISTER_D2H: SataFisType = 52;
pub const SATA_FIS_TYPE_REGISTER_H2D: SataFisType = 39;

#[derive(Copy, Clone)]
#[repr(C)]
pub struct SataFisH2d {
    pub fis_type: u8,
    pub pm_port_c: u8,
    pub command: u8,
    pub features: u8,
