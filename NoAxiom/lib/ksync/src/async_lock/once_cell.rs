...
/// # Examples
///
/// This structure is useful for a variety of patterns, most notably for
...
impl<T> OnceCell<T> {
    ...
    /// Take the value out of this `OnceCell`, moving it back to the
    /// uninitialized state.
    ///
    /// # Example
    ///
    ...
    /// # Blocking
    ///
    /// In contrast to the `wait` method, this method blocks the current thread
    /// of execution instead of awaiting.
    ///
    /// This method should not be used in an asynchronous context. It is
    /// intended to be used such that a `OnceCell` can be used in both
    ...
    /// # Blocking
    ///
    /// In contrast to the `get_or_try_init` method, this method blocks the
    /// current thread of execution instead of awaiting.
    ///
    /// This method should not be used in an asynchronous context. It is
    /// intended to be used such that a `OnceCell` can be used in both
    /// asynchronous and synchronous contexts. Calling this method in an
    ...
    /// # Blocking
    ///
    /// In contrast to the `get_or_init` method, this method blocks the current
    /// thread of execution instead of awaiting.
    ///
    /// This method should not be used in an asynchronous context. It is
    /// intended to be used such that a `OnceCell` can be used in both
    /// asynchronous and synchronous contexts. Calling this method in an
    ...
    /// # Blocking
    ///
    /// In contrast to the `set` method, this method blocks the current thread
    /// of execution instead of awaiting.
    ///
    /// This method should not be used in an asynchronous context. It is
    /// intended to be used such that a `OnceCell` can be used in both
    ...
    async fn initialize_or_wait<E, Fut: Future<Output = Result<T, E>>, F: FnOnce() -> Fut>(
        ...
        ///
        /// If the closure panics, this ensures that the cell's state is set
        /// back to `UNINITIALIZED` and that the next listener is
        /// notified.
